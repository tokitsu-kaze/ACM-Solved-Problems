...
////Run ID: 
////Submit time: 2017-12-13 14:56:40
////Compiler: GUN C++
//////////////////////////////////////////////////////
////Problem ID: 5050
////Problem Title: 
...
#define MAXN 251	//题目最大位数/4，要不大直接设为最大位数也行
...
struct bigint
{
	...
	inline int operator>(const bigint&a)
	{
	...
	inline bigint C(const int m,const int n)
	{
		combination(num,m,n);
		sgn=1 ;
		return*this ;
	}
	inline bigint P(const int m,const int n)
	{
		permutation(num,m,n);
		sgn=1 ;
		return*this ;
